package com.heggies.belajarcrud;
	...
	class LoadSemuaDataSiswa extends AsyncTask<String, String, String> {
		...
		protected void onPostExecute(String file_url) {
			...
			runOnUiThread(new Runnable() {
				...
				@Override
				public void run() {
					ListAdapter adapter = new SimpleAdapter(MainActivity.this, listsiswa1, R.layout.komponendata, new String[] {TAG_ID, TAG_NISN, TAG_NAMA, TAG_KELAS, TAG_ALAMAT}, new int[] {R.id.editID, R.id.editNISN, R.id.editNAMA, R.id.editKELAS, R.id.editALAMAT});
